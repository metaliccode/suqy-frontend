      ...
      <div class="inner-header">
        <div class="row">
          <div class="col-lg-2 col-md-2">
            <div class="logo">
              <a href="./index.html">
                <img src="img/logo assuqy.png" alt />
              </a>
            </div>
          </div>
              ...
              <li class="cart-icon">
                ...
                <div class="cart-hover">
                  ...
                  <div class="select-button">
                    <router-link to="/ShopingCart" class="primary-btn view-card">
                      <a href="#" style="color:#fff;">Lihat Keranjang</a>
                    </router-link>
                    <!-- <router-link to="/success" class="primary-btn checkout-btn">
...
export default {
  ...
  // metode hapus item keranjang berjalan jika ada event
  methods: {
    removeItem(idx) {
      ...
      // splice untuk menghapus item di keranjang
      // this.keranjangUser.splice(index, 1);
      // const parsed = JSON.stringify(this.keranjangUser);
      // localStorage.setItem('keranjangUser', parsed);
    }
  },
  // memanggil api untuk keranjang user
  mounted() {
  ...
  // membuat fungsi untuk kalkulasi total belanjaan dengan compute tanpa event
  computed: {
    totalHarga() {
