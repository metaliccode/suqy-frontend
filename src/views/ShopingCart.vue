              ...
              <div class="col-lg-12">
                <div class="proceed-checkout text-left">
                  <ul>
                    ...
                    <li class="subtotal mt-3">
                      Pajak
                      <span>10% ${{ totalHarga*10/100 }}.00</span>
                    </li>
                    <li class="subtotal mt-3">
                      Total Biaya
...
export default {
  ...
  checkout() {
    ...
    // membuka axios untuk metode post api checkout
    axios
      // .post("http://suqy.epizy.com/api/checkout", checkoutData)
  ...
  // memanggil api untuk keranjang user dari axios
  mounted() {
